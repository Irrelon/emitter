...
export declare type EventListenerCallback = (...args: any[]) => any | Promise<any>;
...
export declare class Emitter {
     ...
     */
    _on(eventName: string, id: string, listener: EventListenerCallback): this;
    /**
     * Attach an event listener to the passed event only if the passed
     ...
     * @returns {Emitter} The emitter instance.
     */
    _once(eventName: string, id: string, listener: EventListenerCallback): this;
    /**
     ...
     *     //    data1, data2
     */
    emit(eventName: string, ...data: any[]): Promise<EventReturnFlag>;
...
export declare function makeEmitter(obj: new (...args: any[]) => any, prototypeMode: boolean): Emitter;
